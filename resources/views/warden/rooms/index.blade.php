    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Select a Hostel to View Rooms</h6>
            </div>
            <div class="card-body">
                @if($hostels->count() > 0)
                    <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="mt-3">
                                                    <a href="{{ route('warden.rooms.show', $hostel) }}" 
                                                       class="btn btn-info btn-sm">
                                                        <i class="fas fa-bed fa-sm"></i> View Rooms
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-auto">
                ...
                @else
                    <div class="text-center text-muted">
                        ...
                        <p>You don't have any hostels assigned to manage rooms.</p>
