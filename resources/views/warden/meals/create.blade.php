...
<div class="container-fluid py-4">
    @include('components.breadcrumb', [
        'pageTitle' => 'Add New Meal',
        'breadcrumbs' => [
            ['name' => 'Home', 'url' => url('/')],
            ['name' => 'Meals', 'url' => route('warden.meals.index')],
            ['name' => 'Add New Meal', 'url' => '']
        ]
    ])
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('warden.meals.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="meal_type" class="form-control @error('meal_type') is-invalid @enderror" required>
                                ...
                                <option value="snacks" {{ old('meal_type') == 'snacks' ? 'selected' : '' }}>Snacks</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="menu_description" 
                                      ...
                                      rows="4" 
                                      placeholder="Describe the menu items for this meal...">{{ old('menu_description') }}</textarea>
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Meal
                            </button>
